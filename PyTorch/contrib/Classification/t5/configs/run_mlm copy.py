...
from transformers import AlbertTokenizer, AlbertConfig, AutoModelForSeq2SeqLM
...
def main():
    ...
    tokenizer = T5Tokenizer.from_pretrained("/data/teco-data/models/mengzi-t5-base", legacy=False)
